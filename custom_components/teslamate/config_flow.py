        ...
        if user_input is not None:
            ...
            if "mqtt" not in self.hass.config.components:
                ...
                try:
                    ...
                    errors["car_ids"] = "invalid_car_ids"
                    car_ids = None
                ...
                if not errors:
                    ...
                    _LOGGER.info(
                        f"Setting up TeslaMate integration: "
                        f"prefix='{user_input[CONF_MQTT_PREFIX]}', "
                        f"car_ids={car_ids}, "
                        f"topics will be: {user_input[CONF_MQTT_PREFIX]}/cars/{{car_id}}/..."
                    )
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional("car_ids", default="1"): cv.string,
            }
        )
